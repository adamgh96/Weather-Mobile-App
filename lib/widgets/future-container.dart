// ignore_for_file: prefer_const_constructors, unnecessary_string_interpolations, unnecessary_cast, use_key_in_widget_constructors
...
class DaysContainer extends StatelessWidget {
  ...
  DaysContainer({required this.i});

  @override
  Widget build(BuildContext context) {
    Future<void> getFutureData() async {
      dataFuture = await cl.getFutureWeather(
          "${Provider.of<CityData>(context).cityName}") as Weather3h?;
    }
